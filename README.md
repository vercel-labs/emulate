...
Calendar events support individual reads, partial updates, caller-supplied IDs,
and Java-style gzip/method-override requests. See the [Calendar API](packages/@emulators/google/README.md#calendar).
