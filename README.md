...
- Rate limits are internally consistent across GraphQL and REST using the local shared bucket. They do not model GitHub's operation-specific cost calculation or enforce GitHub's remote quota exhaustion behavior.
