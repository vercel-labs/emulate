...
Google Calendar watch channels notify local callbacks after successful event
writes. See [Calendar notifications](packages/@emulators/google/README.md#calendar).
