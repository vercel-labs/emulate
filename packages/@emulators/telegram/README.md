...
Boots on `http://localhost:4014` with a default seeded bot (`@emulate_bot`), a test user, and a private chat.
...
The CLI assigns the Telegram service to port `4014` by default (next after Twilio at `4013`).
