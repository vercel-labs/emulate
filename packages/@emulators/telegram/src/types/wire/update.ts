...
import type { WireMessageReactionCountUpdated, WireMessageReactionUpdated } from "./reaction-update.js";
...
export function wrapPayload<T extends UpdateType>(update_id: number, type: T, payload: PayloadFor<T>): WireUpdate {
