...
Local drop-in replacement for Vercel, GitHub, Google, Slack, Apple, Microsoft, Okta, AWS, Resend, Stripe, MongoDB Atlas, and Clerk APIs. Built for CI and no-network sandboxes. Fully stateful, production-fidelity API emulation. Not mocks.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>none</td>
      <td>Override advertised base URL (supports <code>{'{service}'}</code> template)</td>
    </tr>
    <tr>
