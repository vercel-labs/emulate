...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Service name: <code>'vercel'</code>, <code>'github'</code>, <code>'google'</code>, <code>'slack'</code>, <code>'apple'</code>, <code>'microsoft'</code>, <code>'aws'</code>, <code>'okta'</code>, <code>'mongoatlas'</code>, <code>'resend'</code>, <code>'stripe'</code>, or <code>'discord'</code></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@emulators/discord</code></td><td>Discord REST API, OAuth 2.0, inspector UI</td></tr>
